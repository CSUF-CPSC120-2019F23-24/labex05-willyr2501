...
int main()
{
  ...
  std::cout << "\nThey are drifting apart as they get closer to 0." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nThe f2 value actually reaches 0." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nThe f3 value reaches infinite because there is a setprecision of 1." << std::endl;
